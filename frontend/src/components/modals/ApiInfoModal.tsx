...
import { Code, Copy, CheckCircle2, ExternalLink, BookOpen } from "lucide-react"
      ...
      <DialogHeader className="bg-gradient-to-r from-primary-500 to-purple-600 text-white px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <DialogTitle className="text-white">API-Dokumentation</DialogTitle>
          </div>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="space-y-6">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
            <h3 className="font-semibold text-slate-900 mb-3">💡 Monitoring-Integration</h3>
            <div className="space-y-3 text-sm text-slate-700">
              ...
              <div>
                <strong className="text-slate-900">Grafana Dashboard:</strong>
                <p className="mt-1">
              ...
              <div>
                <strong className="text-slate-900">Webhook-Integration:</strong>
                <p className="mt-1">
